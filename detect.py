...
0
--weights
H:\Fashion\yolov5x_clothing17\weights\best.pt
--img
394
--device
cpu
...
def run(weights='yolov5s.pt',  # model.pt path(s)
    ...
    if pt and device.type != 'cpu':
        print("running inference for pt file through GPU")
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # NMS
        pred = non_max_suppression(pred, conf_thres, iou_thres, classes, agnostic_nms, max_det=max_det) #problem here *******************************
        #print("NMS prediction= "+ str(pred))
        dt[2] += time_sync() - t3
